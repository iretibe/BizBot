using BizBot.Widget.Client.Pages;
using BizBot.Widget.Components;
using BizBot.Widget.Components.Account;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(BizBot.Widget.Client._Imports).Assembly);
